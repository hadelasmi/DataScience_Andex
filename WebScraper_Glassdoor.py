...
def parse(keyword, place):
	...
	headers = {	'accept': 'text/html,applicat ion/xhtml+xml,application/xml;q=0.9,image/webp,*/*;q=0.8',
	...
	try:
		...
		job_litsting_url = 'https://www.glassdoor.fr/Emploi/paris-banque-emplois-SRCH_IL.0,5_IC2881970_KE6,12.htm'
		...
		if place_id:
			...
			XPATH_COMPANY = './/div[@class="jobHeader"]/a/div/text()'
